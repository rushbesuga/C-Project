...
namespace RabbitmqTest
{
    public class Class1 : IDisposable
    {
        ...
        public void Sub(Action<string> notify)
        {
            ...
            _channel.ExchangeDeclare(exchange: Exchange, type: exchangeType, durable: true, false);
            Dictionary<String, Object> arguments = new Dictionary<String, Object>();
            arguments.Add("x-queue-mode", "lazy");
            string queueName = _channel.QueueDeclare("test",durable:true, false,false, arguments).QueueName;
