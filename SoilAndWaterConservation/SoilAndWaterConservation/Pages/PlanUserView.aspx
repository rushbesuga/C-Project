...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="col-md-12 div-right div-card-2" style="font-size: 20px">
        <table align="center">
                ...
                <tr>
                    <td align="right" style="width:150px"><span class="div-left">開工剩餘天數：</span></td>
                    <td align="left"><span id="tbStartWorkExpirationRemainingDays"></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="right" style="width:150px"><span class="div-left">完工剩餘天數：</span></td>
                    <td align="left"><span id="tbFinishWorkExpirationRemainingDays"></span></td>
                </tr>
            </table>
    </div>
